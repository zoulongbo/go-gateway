...
项目地址：https://github.com/zoulongbo/go-gateway
### 现在开始
- 安装软件依赖
go mod使用请查阅：
...
[GIN-debug] GET    /demo/index               --> github.com/zoulongbo/go-gateway/controller.(*Demo).Index-fm (6 handlers)
[GIN-debug] GET    /demo/bind                --> github.com/zoulongbo/go-gateway/controller.(*Demo).Bind-fm (6 handlers)
[GIN-debug] GET    /demo/dao                 --> github.com/zoulongbo/go-gateway/controller.(*Demo).Dao-fm (6 handlers)
[GIN-debug] GET    /demo/redis               --> github.com/zoulongbo/go-gateway/controller.(*Demo).Redis-fm (6 handlers)
...
[INFO][2019-06-16T11:39:26.802][log.go:58] _com_mysql_success||affected_row=1||traceid=c0a8fe445d05b9ee07b80f9f66cb39b0||spanid=9dad47aa1408d2ac||source=/Users/niuyufu/go/src/github.com/zoulongbo/go-gateway/dao/demo.go:24||proc_time=0.000000000||sql=SELECT * FROM `area`  WHERE (id = '1')||level=sql||current_time=2019-06-16 11:39:26||cspanid=
